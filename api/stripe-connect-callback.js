...
function getSafeReturnOrigin(value, fallbackOrigin) {
  try {
...
module.exports = async (req, res) => {
  ...
  try {
    ...
    const appUrl = getSafeReturnOrigin(state.return_origin, appOrigin) + '/app.html';
    ...
    return res.redirect(303, appOrigin + '/app.html?stripe=error');
  }
};
const crypto = require('node:crypto');
const Stripe = require('stripe');
